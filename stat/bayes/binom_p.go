...
func BinomPiPMS(α,  β float64, n, k, which_pi int64) float64 {
	...
	switch(which_pi) {
	case MEAN : 		pi_hat=BinomPiPostMean(α,  β , n, k)
	case MEDIAN : 		pi_hat=BinomPiPostMedian(α,  β , n, k)
	case MODUS : 		pi_hat=BinomPiPostModus(α,  β , n, k)
	}
