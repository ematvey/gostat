...
func PoissonLambdaIQR(y int64, r, v float64) float64 {
	qf := PoissonLambda_Qtl_GPri(y, r, v)
	q1 := qf(0.25)
	q3 := qf(0.75)
	return (q3 - q1)
}
...
// untested ...
func PoissonLambda_CrI_GPri(y int64, r, v, α float64) (lo, hi float64) {
	/*
...
func PoissonLambda_OneSidedTst(y int64, r, v, α, λ0 float64) bool {
	cdf := PoissonLambda_CDF_GPri(y, r, v)
	p0 := cdf(λ0)
...
// Bolstad 2007 (2e): 194.
// H0: λ = λ0 vs H1: λ != λ0
func PoissonLambda_TwoSidedTst(y int64, r, v, α, λ0 float64) bool {
